...
/**
 * A small "scroll" hint pinned to the bottom of a full-screen hero. The chevron
 * bobs gently (GSAP) to signal there's content below the fold. Shared across the
 * routes that lead with a full-viewport hero (/contact, /craft). Purely
 * decorative (aria-hidden, pointer-events-none); static for reduced motion.
 */
