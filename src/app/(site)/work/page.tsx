...
export const metadata: Metadata = {
  title: "Work",
  description:
    "Selected case studies: Nous Sommes Un (a cinematic restaurant site), The 6ix Aesthetics (a premium med spa site), The Field of Roses (a quiet single-page experience), Halix Solutions (a custom AI automation studio for marketing agencies), Honey Notes (a local-first meeting note taker), this motion-led portfolio, a Shopify UX/SEO audit for Minoa Home, and a Python/Electron lead-gen tool.",
